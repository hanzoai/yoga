 ...
 *
 * clang-format off
 * @generated SignedSource<<3ea77591fd3b8591e14edb4b487b9271>>
...
TEST(YogaTest, grid_fr_span_2_proportion_zero_sum_with_non_spanned_track) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 0);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 0);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 0);
