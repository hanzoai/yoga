 ...
 *
 * clang-format off
 * @generated SignedSource<<a1c787414a0f9719b5b5cb941e87dac5>>
...
TEST(YogaTest, grid_align_items_baseline_child_multiline) {
  ...
  YGNodeStyleSetGridTemplateColumnsCount(root_child1, 2);
  YGNodeStyleSetGridTemplateColumn(root_child1, 0, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateColumn(root_child1, 1, YGGridTrackTypeAuto, 0);
