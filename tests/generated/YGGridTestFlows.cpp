 ...
 *
 * clang-format off
 * @generated SignedSource<<04e4d9fee076442520908166775d640c>>
...
TEST(YogaTest, grid_indefinite_container_size_percentage_tracks) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePercent, 50);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePercent, 100);
...
TEST(YogaTest, init_track_intrinsic_sizing) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
...
TEST(YogaTest, resolve_intrinsic_progressive_spans) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypeAuto, 0);
...
TEST(YogaTest, expand_flexible_flex_less_than_one) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 3);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 0.5f);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 0.3f);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 0.2f);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeFr, 0.6f);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 0.4f);
  YGNodeStyleSetWidth(root, 400);
  YGNodeStyleSetHeight(root, 300);
...
TEST(YogaTest, percentage_tracks_definite_container) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 3);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePercent, 20);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePercent, 30);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePercent, 50);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePercent, 40);
...
TEST(YogaTest, complex_all_features_combined) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateColumn(root, 4, YGGridTrackTypePercent, 30);
  YGNodeStyleSetGridTemplateRowsCount(root, 4);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 80);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 3, YGGridTrackTypePercent, 40);
  YGNodeStyleSetWidth(root, 800);
  YGNodeStyleSetHeight(root, 600);
  YGNodeStyleSetGap(root, YGGutterAll, 10);
  YGNodeStyleSetJustifyContent(root, YGJustifySpaceEvenly);
