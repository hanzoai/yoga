 ...
 *
 * clang-format off
 * @generated SignedSource<<3f44720a10aaefaa8fe06a60f1eeb275>>
...
TEST(YogaTest, grid_all_properties) {
  ...
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 100);
  ...
  YGNodeStyleSetGridAutoRowsCount(root, 2);
  YGNodeStyleSetGridAutoRow(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridAutoRow(root, 1, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGridAutoColumnsCount(root, 2);
  YGNodeStyleSetGridAutoColumn(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridAutoColumn(root, 1, YGGridTrackTypePoints, 200);
...
TEST(YogaTest, grid_auto_tracks) {
  ...
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 50);
...
TEST(YogaTest, grid_auto_tracks_with_margins) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGap(root, YGGutterColumn, 10);
  YGNodeStyleSetGap(root, YGGutterRow, 15);
...
TEST(YogaTest, grid_holy_grail) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 80);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 60);
...
TEST(YogaTest, grid_sidebar_layout) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 2);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 250);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 1);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeFr, 1);
...
TEST(YogaTest, grid_header_content_footer) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 80);
  YGNodeStyleSetWidth(root, 400);
...
TEST(YogaTest, grid_card_layout) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 250);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 250);
...
TEST(YogaTest, grid_dashboard_layout) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 3);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 220);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 70);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
...
TEST(YogaTest, grid_magazine_layout) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 2);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 300);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 200);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 200);
...
TEST(YogaTest, grid_app_layout) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 2);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 60);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 60);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 50);
  YGNodeStyleSetWidth(root, 400);
  YGNodeStyleSetHeight(root, 600);
...
TEST(YogaTest, grid_with_percentage_tracks) {
  ...
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePercent, 40);
...
TEST(YogaTest, grid_mixed_units) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 80);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 80);
...
TEST(YogaTest, grid_implicit_rows) {
  ...
  YGNodeStyleSetGridTemplateRowsCount(root, 1);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridAutoRowsCount(root, 1);
  YGNodeStyleSetGridAutoRow(root, 0, YGGridTrackTypePoints, 80);
...
TEST(YogaTest, grid_implicit_columns) {
  ...
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridAutoColumnsCount(root, 1);
  YGNodeStyleSetGridAutoColumn(root, 0, YGGridTrackTypePoints, 80);
...
TEST(YogaTest, grid_complex_spanning) {
  ...
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 3, YGGridTrackTypePoints, 100);
  YGNodeStyleSetWidth(root, 400);
  YGNodeStyleSetHeight(root, 400);
...
TEST(YogaTest, grid_all_fractional_units) {
  ...
  YGNodeStyleSetGridTemplateColumnsCount(root, 3);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 3);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypeFr, 2);
  YGNodeStyleSetWidth(root, 400);
  YGNodeStyleSetHeight(root, 600);
...
TEST(YogaTest, grid_uniform_cells) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRowsCount(root, 3);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypeFr, 1);
...
TEST(YogaTest, grid_large_spans) {
  ...
  YGNodeStyleSetPositionType(root, YGPositionTypeAbsolute);
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 5);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 4, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRowsCount(root, 4);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 3, YGGridTrackTypePoints, 50);
...
TEST(YogaTest, grid_unequal_fractions) {
  ...
  YGNodeStyleSetGridTemplateColumnsCount(root, 3);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeFr, 1);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypeFr, 3);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeFr, 2);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeFr, 1);
  YGNodeStyleSetWidth(root, 600);
  YGNodeStyleSetHeight(root, 300);
...
TEST(YogaTest, grid_single_cell) {
  ...
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 1);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 300);
  YGNodeStyleSetGridTemplateRowsCount(root, 1);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 200);
  YGNodeStyleSetWidth(root, 300);
  YGNodeStyleSetHeight(root, 200);
...
TEST(YogaTest, grid_single_column) {
  ...
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 3, YGGridTrackTypePoints, 120);
  YGNodeStyleSetWidth(root, 200);
...
TEST(YogaTest, grid_single_row) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypePoints, 120);
  YGNodeStyleSetGridTemplateRowsCount(root, 1);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 200);
...
TEST(YogaTest, grid_tall_narrow) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRowsCount(root, 8);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 2, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 3, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 4, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 5, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 6, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRow(root, 7, YGGridTrackTypePoints, 50);
  YGNodeStyleSetWidth(root, 200);
  YGNodeStyleSetHeight(root, 400);
...
TEST(YogaTest, grid_wide_short) {
  ...
  YGNodeStyleSetPositionType(root, YGPositionTypeAbsolute);
  YGNodeStyleSetDisplay(root, YGDisplayGrid);
  YGNodeStyleSetGridTemplateColumnsCount(root, 8);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 4, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 5, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 6, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateColumn(root, 7, YGGridTrackTypePoints, 50);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypePoints, 100);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypePoints, 100);
  YGNodeStyleSetWidth(root, 400);
...
TEST(YogaTest, grid_gap_percentage_definite_size_2) {
  ...
  YGNodeStyleSetGridTemplateColumnsCount(root, 4);
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePercent, 10);
  YGNodeStyleSetGridTemplateColumn(root, 2, YGGridTrackTypePercent, 10);
  YGNodeStyleSetGridTemplateColumn(root, 3, YGGridTrackTypePercent, 10);
  YGNodeStyleSetGridTemplateRowsCount(root, 2);
  YGNodeStyleSetGridTemplateRow(root, 0, YGGridTrackTypeAuto, 0);
  YGNodeStyleSetGridTemplateRow(root, 1, YGGridTrackTypeAuto, 0);
