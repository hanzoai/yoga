 ...
 *
 * clang-format off
 * @generated SignedSource<<af507e5799767923f48516c66cc902e4>>
...
TEST(YogaTest, grid_placement_definite_primary) {
  ...
  YGNodeStyleSetGridTemplateColumn(root, 0, YGGridTrackTypePercent, 33);
  YGNodeStyleSetGridTemplateColumn(root, 1, YGGridTrackTypePercent, 74);
