 ...
 *
 * @generated SignedSource<<1b6682f8929c6d3ed75f15f12aef4662>>
...
test('grid_margins_auto_margins_override_stretch', () => {
  ...
  root_child6.setMeasureFunc(intrinsicSizeMeasureFunc.bind({text: "HH​HH", flexDirection: FlexDirection.Column}));
